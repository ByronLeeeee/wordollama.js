...
const providerPresets: ProviderPreset[] = [
  ...
  { id: "zhipu", labelKey: "models.providers.zhipu", name: "Zhipu GLM", type: "OpenAI", endpoint: "https://open.bigmodel.cn/api/paas/v4/chat/completions", apiMode: "ChatCompletions", icon: "GL" },
  { id: "zhipu-coding", labelKey: "models.providers.zhipuCoding", name: "Zhipu GLM Coding Plan", type: "OpenAI", endpoint: "https://open.bigmodel.cn/api/coding/paas/v4/chat/completions", apiMode: "ChatCompletions", icon: "GC" },
